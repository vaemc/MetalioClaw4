/**
 * @file stress_demo.c
 * Port of LVGL lv_demo_stress for the hardware test screen.
 */
...
static const char* TAG = "StressDemo";
...
void stress_demo_start(void)
{
    ...
    ESP_LOGI(TAG,
             ...
             "normal due to fragmentation)");
    s_timer = lv_timer_create(obj_test_task_cb, STRESS_DEMO_TIME_STEP, NULL);
...
static void obj_test_task_cb(lv_timer_t* tmr)
{
    ...
    switch (g_state) {
        case -1: {
            ...
            if (res != LV_RESULT_OK) {
                ESP_LOGE(TAG, "Memory integrity error");
            }
        ...
        case 1: {
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 5 + 30);
            break;
        }
        ...
        case 2:
            ...
            lv_anim_set_duration(&a, STRESS_DEMO_TIME_STEP * 2);
            lv_anim_set_exec_cb(&a, set_width_anim);
            lv_anim_set_values(&a, 100, 200);
            lv_anim_set_reverse_duration(&a, STRESS_DEMO_TIME_STEP * 2);
            lv_anim_set_repeat_count(&a, LV_ANIM_REPEAT_INFINITE);
            lv_anim_start(&a);

            auto_delete(obj, STRESS_DEMO_TIME_STEP * 10);
        ...
        case 7:
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 2 + 70);

            obj = lv_slider_create(main_page);
            lv_obj_set_style_anim_duration(obj, STRESS_DEMO_TIME_STEP * 8, 0);
            lv_slider_set_value(obj, 5000, LV_ANIM_ON);
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 5 + 22);
        ...
        case 8:
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 3 + 5);
#if LV_USE_CALENDAR
        ...
        case 9:
            lv_textarea_set_text(
                ta,
                "A very very long text which will should make the text area "
                "scrollable"
                "Here area some dummy sentences to be sure the text area will "
                "be really scrollable.");
            break;
        case 10:
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 2 + 18);
            break;
        ...
        case 11:
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 3 + 11);
            break;
        ...
        case 12:
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 20 + 22);
            break;
        ...
        case 13:
            ...
            lv_anim_set_duration(&a, STRESS_DEMO_TIME_STEP * 2);
            lv_anim_set_delay(&a, STRESS_DEMO_TIME_STEP + 25);
            lv_anim_set_reverse_duration(&a, STRESS_DEMO_TIME_STEP * 5);
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 6 + 30);
            break;
        ...
        case 14:
            ...
            {
                lv_timer_t* msgbox_tmr = lv_timer_create(
                    msgbox_delete, STRESS_DEMO_TIME_STEP * 5 + 30, obj);
        ...
        case 16: {
            ...
            auto_delete(tv, STRESS_DEMO_TIME_STEP * 4 + 5);
        ...
        case 18:
            ...
            {
                lv_obj_t* b;
                b = lv_list_add_button(obj, LV_SYMBOL_OK,
                                       "1. Some very long text to scroll");
                auto_delete(b, 10);
                lv_list_add_button(obj, LV_SYMBOL_OK,
                                   "2. Some very long text to scroll");
                lv_list_add_button(obj, LV_SYMBOL_OK,
                                   "3. Some very long text to scroll");
                b = lv_list_add_button(obj, LV_SYMBOL_OK,
                                       "4. Some very long text to scroll");
                auto_delete(b, STRESS_DEMO_TIME_STEP);
                b = lv_list_add_button(obj, LV_SYMBOL_OK,
                                       "5. Some very long text to scroll");
                auto_delete(b, STRESS_DEMO_TIME_STEP + 90);
                b = lv_list_add_button(obj, LV_SYMBOL_OK,
                                       "6. Some very long text to scroll");
                auto_delete(b, STRESS_DEMO_TIME_STEP + 10);
                lv_obj_scroll_to_view(lv_obj_get_child(obj, -1), LV_ANIM_ON);
            }
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 5 + 15);
#endif
        ...
        case 22:
            ...
            lv_spinbox_increment(obj);
            lv_spinbox_increment(obj);
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 2 + 15);
        ...
        case 23:
            obj = lv_chart_create(main_page);
            {
                lv_chart_series_t* s1 = lv_chart_add_series(
                    obj, lv_palette_main(LV_PALETTE_RED),
                ...
                auto_delete(obj, STRESS_DEMO_TIME_STEP * 3);
            }
        ...
        case 24:
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 2 + 20);
            ...
            auto_delete(obj, STRESS_DEMO_TIME_STEP * 1 + 60);
